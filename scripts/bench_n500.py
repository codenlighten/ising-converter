"""Confirm ising_lab.SA's speedup vs neal.SA holds at N=500."""
...
CSV_PATH = Path("results/sk_n500.csv")
JSON_PATH = Path("results/sk_n500.json")
...
def main():
    ...
    summarize(records, f"N=500 hard regime (panel-best as truth, {NUM_SWEEPS} sweeps)")
